...
export const festivals: Festival[] = [
  {
    ...
    date: "2026-01-23",
    description: "Festival of spring and Saraswati Puja. Auspicious for starting education and new ventures.",
    descriptionTelugu: "వసంత కాలం ఆరంభం. సరస్వతీ పూజ. విద్యారంభానికి శుభదినం.",
    type: "major",
    relatedTithi: "Panchami",
  },
  {
    id: "ugadi-2026",
    name: "Ugadi",
  ...
  },
  {
    ...
    // Kartika Shukla Chaturthi (sunrise tithi Chaturthi on this date); the
    // earlier 2026-10-24 was Ashwayuja Shukla Trayodashi, i.e. wrong.
    date: "2026-11-13",
  ...
  // ---- 2027 ----
  // Dates cross-checked two ways: against Drik Panchang's Telugu calendar and
  // against this app's own panchang engine, using the same observance
  // conventions the 2026 entries follow (e.g. madhyahna tithi for Chavithi and
  // Rama Navami, pradosha Amavasya for Deepavali, nishita Chaturdashi for
  // Shivaratri, Chaitra Purnima for Hanuman Jayanti).
  {
    id: "makara-sankranti-2027",
    name: "Makara Sankranti",
    nameTelugu: "మకర సంక్రాంతి",
    date: "2027-01-15",
    description: "Harvest festival marking the sun's transition into Makara. Celebrated with kite flying and traditional sweets.",
  ...
  {
    // The Vaikunta Ekadashi of the 2026-27 Dhanurmasa (Margashira Shukla
    // Ekadashi) falls in late December 2026.
    id: "ekadashi-special-2027",
    name: "Vaikunta Ekadashi",
    nameTelugu: "వైకుంఠ ఏకాదశి",
    date: "2026-12-20",
    description: "Most auspicious Ekadashi. Gate of Vaikunta opens on this day.",
